...
class NQJTimesImpl implements NQJTimes{
    NQJTimesImpl() {
    }
    ...
    @Override public NQJTimes copy() {
        NQJTimes result = new NQJTimesImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJTimes copyWithRefs() {
        NQJTimes res = copy();
        return res;
    }
