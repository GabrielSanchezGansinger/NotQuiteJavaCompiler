...
class NQJImplementsInterfaceImpl implements NQJImplementsInterface{
    NQJImplementsInterfaceImpl(String name) {
        if (name == null)
    ...
    @Override public NQJImplementsInterface copy() {
        NQJImplementsInterface result = new NQJImplementsInterfaceImpl(name);
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJImplementsInterface copyWithRefs() {
        NQJImplementsInterface res = copy();
        return res;
    }
    ...
    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_ImplementsInterface(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_ImplementsInterface(this);
    }
    ...
    public boolean structuralEquals(NQJElement e) {
        if (e instanceof NQJImplementsInterface) {
            NQJImplementsInterface o = (NQJImplementsInterface) e;
