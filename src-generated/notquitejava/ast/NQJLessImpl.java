...
class NQJLessImpl implements NQJLess{
    NQJLessImpl() {
    }
    ...
    @Override public NQJLess copy() {
        NQJLess result = new NQJLessImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJLess copyWithRefs() {
        NQJLess res = copy();
        return res;
    }
