...
class NQJImplementsNothingImpl implements NQJImplementsNothing{
    NQJImplementsNothingImpl() {
    }
    ...
    @Override public NQJImplementsNothing copy() {
        NQJImplementsNothing result = new NQJImplementsNothingImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJImplementsNothing copyWithRefs() {
        NQJImplementsNothing res = copy();
        return res;
    }
    ...
    @Override public <T> T match(NQJImplements.Matcher<T> matcher) {
        return matcher.case_ImplementsNothing(this);
    }
    @Override public void match(NQJImplements.MatcherVoid matcher) {
        matcher.case_ImplementsNothing(this);
    }
    ...
    @Override public String toString() {
        return "ImplementsNothing";
    }
    public boolean structuralEquals(NQJElement e) {
        return e instanceof NQJImplementsNothing;
    }
