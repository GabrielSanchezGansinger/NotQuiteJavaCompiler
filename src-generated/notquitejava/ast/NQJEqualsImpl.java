...
class NQJEqualsImpl implements NQJEquals{
    NQJEqualsImpl() {
    }
    ...
    @Override public NQJEquals copy() {
        NQJEquals result = new NQJEqualsImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJEquals copyWithRefs() {
        NQJEquals res = copy();
        return res;
    }
    ...
    @Override public <T> T match(NQJOperator.Matcher<T> matcher) {
        return matcher.case_Equals(this);
    }
    @Override public void match(NQJOperator.MatcherVoid matcher) {
        matcher.case_Equals(this);
    }
