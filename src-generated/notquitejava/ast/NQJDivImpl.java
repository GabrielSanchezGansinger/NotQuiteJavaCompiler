...
class NQJDivImpl implements NQJDiv{
    NQJDivImpl() {
    }
    ...
    @Override public NQJDiv copy() {
        NQJDiv result = new NQJDivImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJDiv copyWithRefs() {
        NQJDiv res = copy();
        return res;
    }
