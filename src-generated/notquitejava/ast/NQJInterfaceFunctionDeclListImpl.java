...
class NQJInterfaceFunctionDeclListImpl extends NQJInterfaceFunctionDeclList {
    ...
    protected void other_setParentToThis(NQJInterfaceFunctionDecl t) {
        t.setParent(this);
    }

    protected void other_clearParent(NQJInterfaceFunctionDecl t) {
        t.setParent(null);
    }

    @Override
    public NQJElement set(int i, NQJElement newElement) {
        return ((AsgList<NQJInterfaceFunctionDecl>) this).set(i, (NQJInterfaceFunctionDecl) newElement);
    }

    @Override public <T> T match(NQJElement.Matcher<T> matcher) {
        return matcher.case_InterfaceFunctionDeclList(this);
    }
    @Override public void match(NQJElement.MatcherVoid matcher) {
        matcher.case_InterfaceFunctionDeclList(this);
    }
    ...
    @Override public void clearAttributes() {
        for (NQJInterfaceFunctionDecl child : this) {
    ...
    @Override public String toString() {
        StringBuilder result = new StringBuilder("InterfaceFunctionDeclList(");
        boolean first = true;
        for (NQJInterfaceFunctionDecl i : this ) {
