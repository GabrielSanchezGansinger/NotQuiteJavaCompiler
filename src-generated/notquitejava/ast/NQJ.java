...
public class NQJ {
    ...
    public static NQJInterfaceFunctionDecl InterfaceFunctionDecl(NQJType returnType, String name, NQJVarDeclList formalParameters) {
        return new NQJInterfaceFunctionDeclImpl(returnType, name, formalParameters);
    }
    public static NQJInterfaceDecl InterfaceDecl(String name, NQJInterfaceFunctionDeclList funcs) {
        return new NQJInterfaceDeclImpl(name, funcs);
    }
    ...
    public static NQJClassDecl ClassDecl(String name, NQJExtended extended, NQJImplements impl, NQJVarDeclList fields, NQJFunctionDeclList methods) {
        return new NQJClassDeclImpl(name, extended, impl, fields, methods);
    }
    public static NQJImplementsInterface ImplementsInterface(String name) {
        return new NQJImplementsInterfaceImpl(name);
    }
    ...
    public static NQJTypeArray TypeArray(NQJType componentType, NQJExpr dimSize) {
        return new NQJTypeArrayImpl(componentType, dimSize);
    }
    ...
    public static NQJTypeClass TypeClass(String name) {
        return new NQJTypeClassImpl(name);
    }
    ...
    public static NQJInterfaceFunctionDeclList InterfaceFunctionDeclList(NQJInterfaceFunctionDecl ... elements ) {
        NQJInterfaceFunctionDeclList l = new NQJInterfaceFunctionDeclListImpl();
        l.addAll(Arrays.asList(elements));
        return l;
    }
    public static NQJInterfaceFunctionDeclList InterfaceFunctionDeclList(Iterable<NQJInterfaceFunctionDecl> elements ) {
        NQJInterfaceFunctionDeclList l = new NQJInterfaceFunctionDeclListImpl();
        if (elements instanceof Collection) l.addAll((Collection<? extends NQJInterfaceFunctionDecl>) elements);
        else for (NQJInterfaceFunctionDecl elem : elements) l.add(elem);
        return l;
    }
    public static NQJImplementsInterfaceList ImplementsInterfaceList(NQJImplementsInterface ... elements ) {
        NQJImplementsInterfaceList l = new NQJImplementsInterfaceListImpl();
        l.addAll(Arrays.asList(elements));
        return l;
    }
    public static NQJImplementsInterfaceList ImplementsInterfaceList(Iterable<NQJImplementsInterface> elements ) {
        NQJImplementsInterfaceList l = new NQJImplementsInterfaceListImpl();
        if (elements instanceof Collection) l.addAll((Collection<? extends NQJImplementsInterface>) elements);
        else for (NQJImplementsInterface elem : elements) l.add(elem);
        return l;
    }
