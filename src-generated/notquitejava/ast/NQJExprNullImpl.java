...
class NQJExprNullImpl implements NQJExprNull{
    NQJExprNullImpl() {
    }
    ...
    @Override public NQJExprNull copy() {
        NQJExprNull result = new NQJExprNullImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJExprNull copyWithRefs() {
        NQJExprNull res = copy();
        return res;
    }
    ...
    public boolean structuralEquals(NQJElement e) {
        return e instanceof NQJExprNull;
    }
