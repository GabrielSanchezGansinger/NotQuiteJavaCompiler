...
class NQJExprThisImpl implements NQJExprThis{
    NQJExprThisImpl() {
    }
    ...
    @Override public NQJExprThis copy() {
        NQJExprThis result = new NQJExprThisImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJExprThis copyWithRefs() {
        NQJExprThis res = copy();
        return res;
    }
    ...
    public boolean structuralEquals(NQJElement e) {
        return e instanceof NQJExprThis;
    }
