...
class NQJExtendsNothingImpl implements NQJExtendsNothing{
    NQJExtendsNothingImpl() {
    }
    ...
    @Override public NQJExtendsNothing copy() {
        NQJExtendsNothing result = new NQJExtendsNothingImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJExtendsNothing copyWithRefs() {
        NQJExtendsNothing res = copy();
        return res;
    }
    ...
    @Override public <T> T match(NQJExtended.Matcher<T> matcher) {
        return matcher.case_ExtendsNothing(this);
    }
    @Override public void match(NQJExtended.MatcherVoid matcher) {
        matcher.case_ExtendsNothing(this);
    }
    ...
    public boolean structuralEquals(NQJElement e) {
        return e instanceof NQJExtendsNothing;
    }
