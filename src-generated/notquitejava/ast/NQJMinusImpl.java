...
class NQJMinusImpl implements NQJMinus{
    ...
    @Override public NQJMinus copy() {
        NQJMinus result = new NQJMinusImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJMinus copyWithRefs() {
        NQJMinus res = copy();
        return res;
    }
