...
class NQJPlusImpl implements NQJPlus{
    NQJPlusImpl() {
    }
    ...
    @Override public NQJPlus copy() {
        NQJPlus result = new NQJPlusImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJPlus copyWithRefs() {
        NQJPlus res = copy();
        return res;
    }
