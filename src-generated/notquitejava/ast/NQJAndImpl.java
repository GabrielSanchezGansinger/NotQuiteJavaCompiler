...
class NQJAndImpl implements NQJAnd{
    NQJAndImpl() {
    }
    ...
    @Override public NQJAnd copy() {
        NQJAnd result = new NQJAndImpl();
result.setSourcePosition(getSourcePosition());
        return result;
    }

    @Override public NQJAnd copyWithRefs() {
        NQJAnd res = copy();
        return res;
    }
