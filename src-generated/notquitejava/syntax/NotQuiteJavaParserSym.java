...
public class NotQuiteJavaParserSym {
  ...
  static final int functionDecl = 10;
  static final int expr = 21;
  static final int paramList = 11;
  static final int paramListRest = 12;
  static final int type = 13;
  static final int interfaceMemberDeclList = 5;
  ...
  static final int brackets = 15;
  static final int implementsList = 7;
  static final int program = 0;
  static final int varDecl = 9;
  static final int blockStatement = 20;
  static final int baseType = 14;
  static final int exprListRest = 26;
  static final int statementList = 19;
  static final int interfaceMemberDecl = 6;
  static final int memberDeclList = 8;
  static final int topLevelDeclList = 1;
  static final int topLevelDecl = 2;
  static final int exprBrackets = 16;
