...
class ConstBoolImpl implements ConstBool{
    ConstBoolImpl(boolean boolVal) {
    ...
    @Override public ConstBool copy() {
        ConstBool result = new ConstBoolImpl(boolVal);
        return result;
    }

    @Override public ConstBool copyWithRefs() {
        ConstBool res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Const.Matcher<T> matcher) {
        return matcher.case_ConstBool(this);
    }
    @Override public void match(Const.MatcherVoid matcher) {
        matcher.case_ConstBool(this);
    }
    ...
    public boolean structuralEquals(Element e) {
        if (e instanceof ConstBool) {
            ConstBool o = (ConstBool) e;
            return java.util.Objects.equals(boolVal, o.getBoolVal());
        } else {
            return false;
        }
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((ConstBool)this);
    }
    /** */
    public Type calculateType() {
        return minillvm.analysis.Typechecker.calculateType((ConstBool)this);
    }
}
