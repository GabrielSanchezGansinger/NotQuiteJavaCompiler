...
class SizeofImpl implements Sizeof{
    SizeofImpl(TypeStruct structType) {
        if (structType == null)
    ...
    @Override public Sizeof copy() {
        Sizeof result = new SizeofImpl(structType);
        return result;
    }

    @Override public Sizeof copyWithRefs() {
        Sizeof res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Const.Matcher<T> matcher) {
        return matcher.case_Sizeof(this);
    }
    @Override public void match(Const.MatcherVoid matcher) {
        matcher.case_Sizeof(this);
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((Sizeof)this);
    }
    /** */
    public Type calculateType() {
        return minillvm.analysis.Typechecker.calculateType((Sizeof)this);
    }
}
