...
class NullpointerImpl implements Nullpointer{
    NullpointerImpl() {
    }
    ...
    @Override public Nullpointer copy() {
        Nullpointer result = new NullpointerImpl();
        return result;
    }

    @Override public Nullpointer copyWithRefs() {
        Nullpointer res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Const.Matcher<T> matcher) {
        return matcher.case_Nullpointer(this);
    }
    @Override public void match(Const.MatcherVoid matcher) {
        matcher.case_Nullpointer(this);
    }
    ...
    public boolean structuralEquals(Element e) {
        return e instanceof Nullpointer;
    }
    /** */
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((Nullpointer)this);
    }
    /** */
    public Type calculateType() {
        return minillvm.analysis.Typechecker.calculateType((Nullpointer)this);
    }
}
