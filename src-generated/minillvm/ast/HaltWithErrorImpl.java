...
class HaltWithErrorImpl implements HaltWithError{
    HaltWithErrorImpl(String msg) {
        if (msg == null)
            throw new IllegalArgumentException("Element msg must not be null.");
        this.msg = msg;
    }
    ...
    @Override public HaltWithError copy() {
        HaltWithError result = new HaltWithErrorImpl(msg);
        return result;
    }

    @Override public HaltWithError copyWithRefs() {
        HaltWithError res = copy();
        return res;
    }
    ...
    @Override public <T> T match(Instruction.Matcher<T> matcher) {
        return matcher.case_HaltWithError(this);
    }
    @Override public void match(Instruction.MatcherVoid matcher) {
        matcher.case_HaltWithError(this);
    }
    ...
    public boolean structuralEquals(Element e) {
        if (e instanceof HaltWithError) {
            HaltWithError o = (HaltWithError) e;
            return java.util.Objects.equals(msg, o.getMsg());
        } else {
            return false;
        }
    }
    ...
    public String toString() {
        return minillvm.printer.PrettyPrinter.elementToString((HaltWithError)this);
    }
}
