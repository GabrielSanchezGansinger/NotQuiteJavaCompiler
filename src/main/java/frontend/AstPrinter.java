...
public class AstPrinter implements NQJElement.Visitor {
    ...
    @Override
    public void visit(NQJTypeClass typeClass) {
    ...
    @Override
    public void visit(NQJInterfaceFunctionDecl interfaceFunctionDecl) {
        interfaceFunctionDecl.getReturnType().accept(this);
        print(" ");
        print(interfaceFunctionDecl.getName());
        print("(");
        for (NQJVarDecl p : interfaceFunctionDecl.getFormalParameters()) {
    ...
    public void visit(NQJInterfaceDecl interfaceDecl) {
        ...
        indent++;
        println(" {");
        interfaceDecl.getFuncs().accept(this);
        indent--;
        println("}");
    }
    ...
    @Override
    public void visit(NQJInterfaceFunctionDeclList interfaceFunctionDeclList) {
        for (NQJInterfaceFunctionDecl interF : interfaceFunctionDeclList) {
            interF.accept(this);
            println();
        }
    }
    ...
    @Override
    public void visit(NQJImplementsInterfaceList implementsInterfaceList) {
        print("implements ");
        for (NQJImplementsInterface imp : implementsInterfaceList) {
            if (imp != implementsInterfaceList.get(0)) {
                print(" ,");
            }
            imp.accept(this);
        }
    ...
    @Override
    public void visit(NQJImplementsInterface implementsInterface) {
        print(implementsInterface.getName());
    }
