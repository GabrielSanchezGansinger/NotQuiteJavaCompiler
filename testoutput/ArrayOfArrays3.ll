...
%"array_%\22array_%\5C22array_%array_i32*\5C22*\22*" = type {
     i32  ; length
    ,[0 x %"array_%\22array_%array_i32*\22*"*]  ; data
}

%"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*" = type {
     i32  ; length
    ,[0 x %"array_%\22array_%\5C22array_%array_i32*\5C22*\22*"*]  ; data
}

%"array_%\22array_%array_i32*\22*1" = type {
     i32  ; length
    ,[0 x %"array_%array_i32*"*]  ; data
}
...
init:
    ...
    %newArray3 = call %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* @newArray(i32 2)
    %castValue = bitcast %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray3 to %"array_%\22array_%array_i32*\22*"*
    store %"array_%\22array_%array_i32*\22*"* %castValue, %"array_%\22array_%array_i32*\22*"** %arr
...
indexInRange:
    ...
    %newArray4 = call %"array_%\22array_%array_i32*\22*1"* @newArray2(i32 2)
    %castValue1 = bitcast %"array_%\22array_%array_i32*\22*1"* %newArray4 to %"array_%array_i32*"*
    store %"array_%array_i32*"* %castValue1, %"array_%array_i32*"** %indexAddr
...
indexInRange2:
    ...
    %newArray5 = call %array_i32* @newArray1(i32 2)
...
define %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* @newArray(i32 %size) {
init:
...
goodSize:
    ...
    %newArray3 = bitcast i8* %mallocRes to %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"*
    %sizeAddr = getelementptr %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*", %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray3, i32 0, i32 0
...
loopBody:
    %iAddr = getelementptr %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*", %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray3, i32 0, i32 1, i32 %i
    store %"array_%\22array_%\5C22array_%array_i32*\5C22*\22*"* null, %"array_%\22array_%\5C22array_%array_i32*\5C22*\22*"** %iAddr
    %nextI = add i32 %i, 1
    store i32 %nextI, i32* %iVar
    br label %loopStart
    
loopEnd:
    ret %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray3
...
define %"array_%\22array_%array_i32*\22*1"* @newArray2(i32 %size) {
init:
    %sizeLessThanZero = icmp slt i32 %size, 0
    br i1 %sizeLessThanZero, label %negativeSize, label %goodSize
...
goodSize:
    ...
    %arraySizeWitLen = add i32 %arraySizeInBytes, 4
    %mallocRes = call i8* @malloc(i32 %arraySizeWitLen)
    %newArray3 = bitcast i8* %mallocRes to %"array_%\22array_%array_i32*\22*1"*
    %sizeAddr = getelementptr %"array_%\22array_%array_i32*\22*1", %"array_%\22array_%array_i32*\22*1"* %newArray3, i32 0, i32 0
    store i32 %size, i32* %sizeAddr
    %iVar = alloca i32
    store i32 0, i32* %iVar
    br label %loopStart
...
loopBody:
    %iAddr = getelementptr %"array_%\22array_%array_i32*\22*1", %"array_%\22array_%array_i32*\22*1"* %newArray3, i32 0, i32 1, i32 %i
...
loopEnd:
    ret %"array_%\22array_%array_i32*\22*1"* %newArray3
