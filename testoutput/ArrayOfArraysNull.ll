...
init:
    ...
    %newArray1 = call %"array_%\22array_%array_i32*\22*"* @newArray(i32 2)
    %castValue = bitcast %"array_%\22array_%array_i32*\22*"* %newArray1 to %"array_%array_i32*"*
...
indexInRange:
    ...
    %castValue1 = bitcast i8* null to %array_i32*
    %resEqImpl = icmp eq %array_i32* %t1, %castValue1
