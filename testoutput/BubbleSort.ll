@.print_message_1 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 44\0A\00", align 1
@.print_message_2 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 44\0A\00", align 1
@.print_message_3 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 45\0A\00", align 1
@.print_message_4 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 45\0A\00", align 1
@.print_message_5 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 48\0A\00", align 1
@.print_message_6 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 48\0A\00", align 1
@.print_message_7 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 49\0A\00", align 1
@.print_message_8 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 49\0A\00", align 1
@.print_message_9 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 50\0A\00", align 1
@.print_message_10 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 50\0A\00", align 1
...
@.print_message_13 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 76\0A\00", align 1
@.print_message_14 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 76\0A\00", align 1
@.print_message_15 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 77\0A\00", align 1
@.print_message_16 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 77\0A\00", align 1
@.print_message_17 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 78\0A\00", align 1
@.print_message_18 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 78\0A\00", align 1
@.print_message_19 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 79\0A\00", align 1
@.print_message_20 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 79\0A\00", align 1
@.print_message_21 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 80\0A\00", align 1
@.print_message_22 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 80\0A\00", align 1
@.print_message_23 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 81\0A\00", align 1
@.print_message_24 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 81\0A\00", align 1
@.print_message_25 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 82\0A\00", align 1
@.print_message_26 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 82\0A\00", align 1
@.print_message_27 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 83\0A\00", align 1
@.print_message_28 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 83\0A\00", align 1
@.print_message_29 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 84\0A\00", align 1
@.print_message_30 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 84\0A\00", align 1
@.print_message_31 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 85\0A\00", align 1
@.print_message_32 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 85\0A\00", align 1
@.print_message_33 = private unnamed_addr constant [29 x i8] c"Array Size must be positive\0A\00", align 1
...
%BBS = type {
     %vTable_BBS*  ; vTablePointer: BBS
    ,%array_i32*  ; number
    ,i32  ; size
}

@vTable_BBS1 = constant %vTable_BBS  {
    i32(%BBS*, i32)* @Start,
    i32(%BBS*)* @Sort,
    i32(%BBS*)* @Print,
    i32(%BBS*, i32)* @Init
...
define i32 @Start(%BBS* %this, i32 %sz) {
initMethod:
    %sz1 = alloca i32
    ...
    %vTablePointer = getelementptr %BBS, %BBS* %this, i32 0, i32 0
    %vTablePoint = load %vTable_BBS*, %vTable_BBS** %vTablePointer
    %procedurePointer = getelementptr %vTable_BBS, %vTable_BBS* %vTablePoint, i32 0, i32 3
    %loadedProcedure = load i32(%BBS*, i32)*, i32(%BBS*, i32)** %procedurePointer
    %t = load i32, i32* %sz1
    %Init_result = call i32 %loadedProcedure(%BBS* %this, i32 %t)
    store i32 %Init_result, i32* %aux01
    ;18 end statement: aux01 = this.Init(sz);
    ;19 start statement : aux01 = this.Print();
    %vTablePointer1 = getelementptr %BBS, %BBS* %this, i32 0, i32 0
    %vTablePoint1 = load %vTable_BBS*, %vTable_BBS** %vTablePointer1
    %procedurePointer1 = getelementptr %vTable_BBS, %vTable_BBS* %vTablePoint1, i32 0, i32 2
    %loadedProcedure1 = load i32(%BBS*)*, i32(%BBS*)** %procedurePointer1
    %Print_result = call i32 %loadedProcedure1(%BBS* %this)
    ...
    %vTablePointer2 = getelementptr %BBS, %BBS* %this, i32 0, i32 0
    %vTablePoint2 = load %vTable_BBS*, %vTable_BBS** %vTablePointer2
    %procedurePointer2 = getelementptr %vTable_BBS, %vTable_BBS* %vTablePoint2, i32 0, i32 1
    %loadedProcedure2 = load i32(%BBS*)*, i32(%BBS*)** %procedurePointer2
    %Sort_result = call i32 %loadedProcedure2(%BBS* %this)
    store i32 %Sort_result, i32* %aux01
    ;21 end statement: aux01 = this.Sort();
    ;22 start statement : aux01 = this.Print();
    %vTablePointer3 = getelementptr %BBS, %BBS* %this, i32 0, i32 0
    %vTablePoint3 = load %vTable_BBS*, %vTable_BBS** %vTablePointer3
    %procedurePointer3 = getelementptr %vTable_BBS, %vTable_BBS* %vTablePoint3, i32 0, i32 2
    %loadedProcedure3 = load i32(%BBS*)*, i32(%BBS*)** %procedurePointer3
    %Print_result1 = call i32 %loadedProcedure3(%BBS* %this)
...
initMethod:
    ...
    %res = getelementptr %BBS, %BBS* %this, i32 0, i32 2
    %t1 = load i32, i32* %res
...
loopBodyStart1:
    ...
    %res1 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t7 = load %array_i32*, %array_i32** %res1
...
indexInRange:
    ...
    %res2 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t10 = load %array_i32*, %array_i32** %res2
...
ifTrue:
    ...
    %res3 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t16 = load %array_i32*, %array_i32** %res3
...
indexInRange2:
    ...
    %res4 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t19 = load %array_i32*, %array_i32** %res4
...
indexInRange3:
    ...
    %res5 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t21 = load %array_i32*, %array_i32** %res5
...
indexInRange4:
    ...
    %res6 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
    %t24 = load %array_i32*, %array_i32** %res6
...
define i32 @Init(%BBS* %this, i32 %sz) {
initMethod:
    %sz1 = alloca i32
    store i32 %sz, i32* %sz1
    ;72 start statement : {
...
indexInRange4:
    ...
    %res7 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
...
indexInRange5:
    ...
    %res8 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
...
indexInRange6:
    ...
    %res9 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
...
indexInRange7:
    ...
    %res10 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
...
indexInRange8:
    ...
    %res11 = getelementptr %BBS, %BBS* %this, i32 0, i32 1
...
define %BBS* @"Create BBS"() {
"Constr class BBS":
    %"struct BBS" = call i8* @malloc(i32 ptrtoint (%BBS* getelementptr (%BBS, %BBS* null, i32 1) to i32))
    %"classPointer BBS" = bitcast i8* %"struct BBS" to %BBS*
    %ffAdress = getelementptr %BBS, %BBS* %"classPointer BBS", i32 0, i32 0
    store %vTable_BBS* @vTable_BBS1, %vTable_BBS** %ffAdress
    %addres = getelementptr %BBS, %BBS* %"classPointer BBS", i32 0, i32 1
    store %array_i32* null, %array_i32** %addres
    %addres1 = getelementptr %BBS, %BBS* %"classPointer BBS", i32 0, i32 2
    store i32 0, i32* %addres1
    ret %BBS* %"classPointer BBS"
...
init:
    ...
    %constrRes = call %BBS* @"Create BBS"()
    %vTablePointer = getelementptr %BBS, %BBS* %constrRes, i32 0, i32 0
    %vTablePoint = load %vTable_BBS*, %vTable_BBS** %vTablePointer
    %procedurePointer = getelementptr %vTable_BBS, %vTable_BBS* %vTablePoint, i32 0, i32 0
    %loadedProcedure = load i32(%BBS*, i32)*, i32(%BBS*, i32)** %procedurePointer
    %Start_result = call i32 %loadedProcedure(%BBS* %constrRes, i32 10)
...
negativeSize:
    ...
    call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.print_message_33, i32 0, i32 0))
    call void @exit(i32 222)
    unreachable
