@.print_message_1 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 39\0A\00", align 1
@.print_message_2 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 39\0A\00", align 1
@.print_message_3 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 47\0A\00", align 1
@.print_message_4 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 47\0A\00", align 1
...
@.print_message_7 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 63\0A\00", align 1
@.print_message_8 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 63\0A\00", align 1
@.print_message_9 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 64\0A\00", align 1
@.print_message_10 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 64\0A\00", align 1
@.print_message_11 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 65\0A\00", align 1
@.print_message_12 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 65\0A\00", align 1
@.print_message_13 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 72\0A\00", align 1
@.print_message_14 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 72\0A\00", align 1
@.print_message_15 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 73\0A\00", align 1
@.print_message_16 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 73\0A\00", align 1
@.print_message_17 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 74\0A\00", align 1
@.print_message_18 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 74\0A\00", align 1
@.print_message_19 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 87\0A\00", align 1
@.print_message_20 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 87\0A\00", align 1
@.print_message_21 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 98\0A\00", align 1
@.print_message_22 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 98\0A\00", align 1
@.print_message_23 = private unnamed_addr constant [34 x i8] c"Nullpointer exception in line 99\0A\00", align 1
@.print_message_24 = private unnamed_addr constant [38 x i8] c"Index out of bounds error in line 99\0A\00", align 1
@.print_message_25 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 100\0A\00", align 1
@.print_message_26 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 100\0A\00", align 1
@.print_message_27 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 101\0A\00", align 1
@.print_message_28 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 101\0A\00", align 1
@.print_message_29 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 102\0A\00", align 1
@.print_message_30 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 102\0A\00", align 1
@.print_message_31 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 103\0A\00", align 1
@.print_message_32 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 103\0A\00", align 1
@.print_message_33 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 104\0A\00", align 1
@.print_message_34 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 104\0A\00", align 1
@.print_message_35 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 105\0A\00", align 1
@.print_message_36 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 105\0A\00", align 1
@.print_message_37 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 106\0A\00", align 1
@.print_message_38 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 106\0A\00", align 1
@.print_message_39 = private unnamed_addr constant [35 x i8] c"Nullpointer exception in line 107\0A\00", align 1
@.print_message_40 = private unnamed_addr constant [39 x i8] c"Index out of bounds error in line 107\0A\00", align 1
...
%QS = type {
     %vTable_QS*  ; vTablePointer: QS
    ,%array_i32*  ; number
    ,i32  ; size
}

@vTable_QS1 = constant %vTable_QS  {
    i32(%QS*, i32)* @Start,
    i32(%QS*, i32, i32)* @Sort,
    i32(%QS*)* @Print,
    i32(%QS*, i32)* @Init
...
define i32 @Start(%QS* %this, i32 %sz) {
initMethod:
    %sz1 = alloca i32
    ...
    %vTablePointer = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint = load %vTable_QS*, %vTable_QS** %vTablePointer
    %procedurePointer = getelementptr %vTable_QS, %vTable_QS* %vTablePoint, i32 0, i32 3
    %loadedProcedure = load i32(%QS*, i32)*, i32(%QS*, i32)** %procedurePointer
    %t = load i32, i32* %sz1
    %Init_result = call i32 %loadedProcedure(%QS* %this, i32 %t)
    store i32 %Init_result, i32* %aux01
    ;18 end statement: aux01 = this.Init(sz);
    ;19 start statement : aux01 = this.Print();
    %vTablePointer1 = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint1 = load %vTable_QS*, %vTable_QS** %vTablePointer1
    %procedurePointer1 = getelementptr %vTable_QS, %vTable_QS* %vTablePoint1, i32 0, i32 2
    %loadedProcedure1 = load i32(%QS*)*, i32(%QS*)** %procedurePointer1
    %Print_result = call i32 %loadedProcedure1(%QS* %this)
    store i32 %Print_result, i32* %aux01
    ;19 end statement: aux01 = this.Print();
    ;20 start statement : printInt(9999);
    call void @print(i32 9999)
    ;20 end statement: printInt(9999);
    ;21 start statement : aux01 = (size - 1);
    %res = getelementptr %QS, %QS* %this, i32 0, i32 2
    %t1 = load i32, i32* %res
    %resSubImpl = sub i32 %t1, 1
    store i32 %resSubImpl, i32* %aux01
    ;21 end statement: aux01 = (size - 1);
    ;22 start statement : aux01 = this.Sort(0, aux01);
    %vTablePointer2 = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint2 = load %vTable_QS*, %vTable_QS** %vTablePointer2
    %procedurePointer2 = getelementptr %vTable_QS, %vTable_QS* %vTablePoint2, i32 0, i32 1
    %loadedProcedure2 = load i32(%QS*, i32, i32)*, i32(%QS*, i32, i32)** %procedurePointer2
    %t2 = load i32, i32* %aux01
    %Sort_result = call i32 %loadedProcedure2(%QS* %this, i32 0, i32 %t2)
    store i32 %Sort_result, i32* %aux01
    ;22 end statement: aux01 = this.Sort(0, aux01);
    ;23 start statement : aux01 = this.Print();
    %vTablePointer3 = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint3 = load %vTable_QS*, %vTable_QS** %vTablePointer3
    %procedurePointer3 = getelementptr %vTable_QS, %vTable_QS* %vTablePoint3, i32 0, i32 2
    %loadedProcedure3 = load i32(%QS*)*, i32(%QS*)** %procedurePointer3
    %Print_result1 = call i32 %loadedProcedure3(%QS* %this)
    store i32 %Print_result1, i32* %aux01
    ;23 end statement: aux01 = this.Print();
...
define i32 @Sort(%QS* %this, i32 %left, i32 %right) {
initMethod:
    %left1 = alloca i32
    ...
    %aux03 = alloca i32
    ;28 start statement : {
    ;29 start statement : int v
    ;29 end statement: int v
    ;30 start statement : int i
    ;30 end statement: int i
    ;31 start statement : int j
    ;31 end statement: int j
    ;32 start statement : int nt
    ;32 end statement: int nt
    ;33 start statement : int t
    ;33 end statement: int t
    ;34 start statement : boolean cont01
    ;34 end statement: boolean cont01
    ;35 start statement : boolean cont02
    ;35 end statement: boolean cont02
    ;36 start statement : int aux03
    ;36 end statement: int aux03
    ;37 start statement : t = 0;
    store i32 0, i32* %t
    ;37 end statement: t = 0;
    ;38 start statement : if ((left < right)) {
...
ifTrue:
    ;38 start statement : {
    ;39 start statement : v = number[right];
    %res = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t3 = load %array_i32*, %array_i32** %res
    %isNull = icmp eq %array_i32* %t3, null
    br i1 %isNull, label %whenIsNull, label %notNull
    
whenIsNull:
    ; ERROR: Nullpointer exception in line 39
...
outOfBounds1:
    ; ERROR: Index out of bounds error in line 39
...
indexInRange:
    ...
    store i32 %t5, i32* %v
    ;39 end statement: v = number[right];
    ;40 start statement : i = (left - 1);
    %t6 = load i32, i32* %left1
    %resSubImpl = sub i32 %t6, 1
    store i32 %resSubImpl, i32* %i
    ;40 end statement: i = (left - 1);
    ;41 start statement : j = right;
    %t7 = load i32, i32* %right1
    store i32 %t7, i32* %j
    ;41 end statement: j = right;
    ;42 start statement : cont01 = true;
    store i1 1, i1* %cont01
    ;42 end statement: cont01 = true;
    ;43 start statement : while (cont01) {
    br label %whileStart
...
loopBodyStart1:
    ;45 start statement : {
    ;46 start statement : i = (i + 1);
    %t10 = load i32, i32* %i
    %resAddImpl = add i32 %t10, 1
    store i32 %resAddImpl, i32* %i
    ;46 end statement: i = (i + 1);
    ;47 start statement : aux03 = number[i];
    %res1 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t11 = load %array_i32*, %array_i32** %res1
...
indexInRange1:
    ...
    ;47 end statement: aux03 = number[i];
    ;48 start statement : if ((! (aux03 < v))) cont02 = false;
...
ifFalse:
    ...
    ;48 end statement: if ((! (aux03 < v))) cont02 = false;
    ;45 end statement: {
    br label %whileStart1
...
loopBodyStart2:
    ...
    %res2 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t18 = load %array_i32*, %array_i32** %res2
...
ifTrue2:
    ;58 start statement : cont02 = false;
    store i1 0, i1* %cont02
    ;58 end statement: cont02 = false;
    br label %endif1
    
ifFalse1:
    ;60 start statement : cont02 = true;
    store i1 1, i1* %cont02
    ;60 end statement: cont02 = true;
    br label %endif1
...
endloop1:
    ...
    ;63 start statement : t = number[i];
    %res3 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t23 = load %array_i32*, %array_i32** %res3
...
indexInRange3:
    ...
    store i32 %t25, i32* %t
    ;63 end statement: t = number[i];
    ;64 start statement : number[i] = number[j];
    %res4 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t26 = load %array_i32*, %array_i32** %res4
...
indexInRange4:
    ...
    %res5 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t28 = load %array_i32*, %array_i32** %res5
...
indexInRange5:
    ...
    ;64 end statement: number[i] = number[j];
    ;65 start statement : number[j] = t;
    %res6 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t31 = load %array_i32*, %array_i32** %res6
...
indexInRange6:
    ...
    ;65 end statement: number[j] = t;
    ;67 start statement : if ((j < (i + 1))) cont01 = false;
    %t34 = load i32, i32* %j
    %t35 = load i32, i32* %i
...
ifTrue3:
    ;68 start statement : cont01 = false;
    store i1 0, i1* %cont01
    ;68 end statement: cont01 = false;
    br label %endif2
    
ifFalse2:
    ;70 start statement : cont01 = true;
    store i1 1, i1* %cont01
    ;70 end statement: cont01 = true;
    br label %endif2
    
endif2:
    ;67 end statement: if ((j < (i + 1))) cont01 = false;
    ;43 end statement: {
    br label %whileStart
    
endloop2:
    ;43 end statement: while (cont01) {
    ;72 start statement : number[j] = number[i];
    %res7 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t36 = load %array_i32*, %array_i32** %res7
    %isNull7 = icmp eq %array_i32* %t36, null
    br i1 %isNull7, label %whenIsNull7, label %notNull7
    
whenIsNull7:
    ; ERROR: Nullpointer exception in line 72
...
outOfBounds15:
    ; ERROR: Index out of bounds error in line 72
...
indexInRange7:
    ...
    %res8 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t38 = load %array_i32*, %array_i32** %res8
...
indexInRange8:
    ...
    ;72 end statement: number[j] = number[i];
    ;73 start statement : number[i] = number[right];
    %res9 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t41 = load %array_i32*, %array_i32** %res9
    %isNull9 = icmp eq %array_i32* %t41, null
    br i1 %isNull9, label %whenIsNull9, label %notNull9
    
whenIsNull9:
    ; ERROR: Nullpointer exception in line 73
...
outOfBounds19:
    ; ERROR: Index out of bounds error in line 73
...
indexInRange9:
    ...
    %res10 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t43 = load %array_i32*, %array_i32** %res10
...
indexInRange10:
    ...
    ;73 end statement: number[i] = number[right];
    ;74 start statement : number[right] = t;
    %res11 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t46 = load %array_i32*, %array_i32** %res11
    %isNull11 = icmp eq %array_i32* %t46, null
    br i1 %isNull11, label %whenIsNull11, label %notNull11
    
whenIsNull11:
    ; ERROR: Nullpointer exception in line 74
...
outOfBounds23:
    ; ERROR: Index out of bounds error in line 74
...
indexInRange11:
    ...
    ;74 end statement: number[right] = t;
    ;75 start statement : nt = this.Sort(left, (i - 1));
    %vTablePointer = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint = load %vTable_QS*, %vTable_QS** %vTablePointer
    %procedurePointer = getelementptr %vTable_QS, %vTable_QS* %vTablePoint, i32 0, i32 1
    %loadedProcedure = load i32(%QS*, i32, i32)*, i32(%QS*, i32, i32)** %procedurePointer
    %t49 = load i32, i32* %left1
    %t50 = load i32, i32* %i
    %resSubImpl2 = sub i32 %t50, 1
    %Sort_result = call i32 %loadedProcedure(%QS* %this, i32 %t49, i32 %resSubImpl2)
    store i32 %Sort_result, i32* %nt
    ;75 end statement: nt = this.Sort(left, (i - 1));
    ;76 start statement : nt = this.Sort((i + 1), right);
    %vTablePointer1 = getelementptr %QS, %QS* %this, i32 0, i32 0
    %vTablePoint1 = load %vTable_QS*, %vTable_QS** %vTablePointer1
    %procedurePointer1 = getelementptr %vTable_QS, %vTable_QS* %vTablePoint1, i32 0, i32 1
    %loadedProcedure1 = load i32(%QS*, i32, i32)*, i32(%QS*, i32, i32)** %procedurePointer1
    %t51 = load i32, i32* %i
    %resAddImpl2 = add i32 %t51, 1
    %t52 = load i32, i32* %right1
    %Sort_result1 = call i32 %loadedProcedure1(%QS* %this, i32 %resAddImpl2, i32 %t52)
    store i32 %Sort_result1, i32* %nt
    ;76 end statement: nt = this.Sort((i + 1), right);
    ;38 end statement: {
    br label %endif3
    
ifFalse3:
    ;78 start statement : nt = 0;
    store i32 0, i32* %nt
    ;78 end statement: nt = 0;
    br label %endif3
    
endif3:
    ;38 end statement: if ((left < right)) {
    ;79 start statement : return 0;
    ret i32 0
    

}

define i32 @Print(%QS* %this) {
initMethod:
    %j = alloca i32
    ;83 start statement : {
    ;84 start statement : int j
    ;84 end statement: int j
    ;85 start statement : j = 0;
    store i32 0, i32* %j
    ;85 end statement: j = 0;
    ;86 start statement : while ((j < size)) {
    br label %whileStart
...
loopBodyStart:
    ;86 start statement : {
    ;87 start statement : printInt(number[j]);
    %res1 = getelementptr %QS, %QS* %this, i32 0, i32 1
...
whenIsNull:
    ; ERROR: Nullpointer exception in line 87
...
outOfBounds1:
    ; ERROR: Index out of bounds error in line 87
...
indexInRange:
    ...
    ;87 end statement: printInt(number[j]);
    ;88 start statement : j = (j + 1);
    %t5 = load i32, i32* %j
    %resAddImpl = add i32 %t5, 1
    store i32 %resAddImpl, i32* %j
    ;88 end statement: j = (j + 1);
    ;86 end statement: {
    br label %whileStart
    
endloop:
    ;86 end statement: while ((j < size)) {
    ;90 start statement : return 0;
    ret i32 0
    

}

define i32 @Init(%QS* %this, i32 %sz) {
initMethod:
    %sz1 = alloca i32
    store i32 %sz, i32* %sz1
    ;94 start statement : {
    ;95 start statement : size = sz;
    %res = getelementptr %QS, %QS* %this, i32 0, i32 2
    %t = load i32, i32* %sz1
    store i32 %t, i32* %res
    ;95 end statement: size = sz;
    ;96 start statement : number = (new int[sz]);
    %res1 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t1 = load i32, i32* %sz1
    %newArray1 = call %array_i32* @newArray(i32 %t1)
    store %array_i32* %newArray1, %array_i32** %res1
    ;96 end statement: number = (new int[sz]);
    ;98 start statement : number[0] = 20;
    %res2 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t2 = load %array_i32*, %array_i32** %res2
    %isNull = icmp eq %array_i32* %t2, null
    br i1 %isNull, label %whenIsNull, label %notNull
...
indexInRange:
    ...
    ;98 end statement: number[0] = 20;
    ;99 start statement : number[1] = 7;
    %res3 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t3 = load %array_i32*, %array_i32** %res3
...
indexInRange1:
    ...
    ;99 end statement: number[1] = 7;
    ;100 start statement : number[2] = 12;
    %res4 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t4 = load %array_i32*, %array_i32** %res4
    %isNull2 = icmp eq %array_i32* %t4, null
    br i1 %isNull2, label %whenIsNull2, label %notNull2
    
whenIsNull2:
    ; ERROR: Nullpointer exception in line 100
    call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.print_message_25, i32 0, i32 0))
    call void @exit(i32 222)
    unreachable
...
outOfBounds5:
    ...
    call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.print_message_26, i32 0, i32 0))
    call void @exit(i32 222)
    unreachable
...
indexInRange2:
    ...
    ;100 end statement: number[2] = 12;
    ;101 start statement : number[3] = 18;
    %res5 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t5 = load %array_i32*, %array_i32** %res5
...
indexInRange3:
    ...
    ;101 end statement: number[3] = 18;
    ;102 start statement : number[4] = 2;
    %res6 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t6 = load %array_i32*, %array_i32** %res6
...
indexInRange4:
    ...
    ;102 end statement: number[4] = 2;
    ;103 start statement : number[5] = 11;
    %res7 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t7 = load %array_i32*, %array_i32** %res7
...
indexInRange5:
    ...
    ;103 end statement: number[5] = 11;
    ;104 start statement : number[6] = 6;
    %res8 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t8 = load %array_i32*, %array_i32** %res8
...
indexInRange6:
    ...
    ;104 end statement: number[6] = 6;
    ;105 start statement : number[7] = 9;
    %res9 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t9 = load %array_i32*, %array_i32** %res9
...
indexInRange7:
    ...
    ;105 end statement: number[7] = 9;
    ;106 start statement : number[8] = 19;
    %res10 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t10 = load %array_i32*, %array_i32** %res10
...
indexInRange8:
    ...
    ;106 end statement: number[8] = 19;
    ;107 start statement : number[9] = 5;
    %res11 = getelementptr %QS, %QS* %this, i32 0, i32 1
    %t11 = load %array_i32*, %array_i32** %res11
    %isNull9 = icmp eq %array_i32* %t11, null
    br i1 %isNull9, label %whenIsNull9, label %notNull9
    
whenIsNull9:
    ; ERROR: Nullpointer exception in line 107
...
outOfBounds19:
    ; ERROR: Index out of bounds error in line 107
...
indexInRange9:
    ...
    ;107 end statement: number[9] = 5;
    ;109 start statement : return 0;
    ret i32 0
...
define %QS* @"Create QS"() {
"Constr class QS":
    %"struct QS" = call i8* @malloc(i32 ptrtoint (%QS* getelementptr (%QS, %QS* null, i32 1) to i32))
    %"classPointer QS" = bitcast i8* %"struct QS" to %QS*
    %ffAdress = getelementptr %QS, %QS* %"classPointer QS", i32 0, i32 0
    store %vTable_QS* @vTable_QS1, %vTable_QS** %ffAdress
    %addres = getelementptr %QS, %QS* %"classPointer QS", i32 0, i32 1
    store %array_i32* null, %array_i32** %addres
    %addres1 = getelementptr %QS, %QS* %"classPointer QS", i32 0, i32 2
    store i32 0, i32* %addres1
    ret %QS* %"classPointer QS"
...
init:
    ...
    %constrRes = call %QS* @"Create QS"()
    %vTablePointer = getelementptr %QS, %QS* %constrRes, i32 0, i32 0
    %vTablePoint = load %vTable_QS*, %vTable_QS** %vTablePointer
    %procedurePointer = getelementptr %vTable_QS, %vTable_QS* %vTablePoint, i32 0, i32 0
    %loadedProcedure = load i32(%QS*, i32)*, i32(%QS*, i32)** %procedurePointer
    %Start_result = call i32 %loadedProcedure(%QS* %constrRes, i32 10)
