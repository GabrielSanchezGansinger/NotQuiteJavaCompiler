...
init:
    ...
    %newArray1 = call %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* @newArray(i32 5)
    %castValue = bitcast %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray1 to %"array_%\22array_%array_i32*\22*"*
    store %"array_%\22array_%array_i32*\22*"* %castValue, %"array_%\22array_%array_i32*\22*"** %a
...
goodSize:
    ...
    %newArray1 = bitcast i8* %mallocRes to %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"*
    %sizeAddr = getelementptr %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*", %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray1, i32 0, i32 0
...
loopBody:
    %iAddr = getelementptr %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*", %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray1, i32 0, i32 1, i32 %i
...
loopEnd:
    ret %"array_%\22array_%\5C22array_%\5C5C22array_%array_i32*\5C5C22*\5C22*\22*"* %newArray1
